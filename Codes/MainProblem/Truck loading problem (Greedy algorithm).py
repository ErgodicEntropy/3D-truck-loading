...
def BP(n,m,E,L,th,S,C): #n is the number of items, m is the total number of available bins, S maximum size of items, C maximum capacity of bins, d number of stacks formed (d < n), E earliest time, L latest time, th hunger threshold
    I = np.zeros(n)
...
print(BP(17153,53540,202207070000,202207121830,3,600,1500))
